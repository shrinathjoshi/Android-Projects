package com.example.hp.recipeapp.mock.api;
...
import com.example.hp.recipeapp.mock.FakeWebServer;
import com.example.hp.recipeapp.model.GlobaDataHolder;
import com.example.hp.recipeapp.view.activities.MainActivity;
import com.example.hp.recipeapp.view.adapter.ProductOverViewPagerAdapter;
import com.example.hp.recipeapp.view.fragments.ProductListFragment;
...
public class ProductLoaderTask extends AsyncTask<String, Void, Void> {
	...
	protected Void doInBackground(String... params) {
		...
		FakeWebServer.getFakeWebServer().getAllCakes();
